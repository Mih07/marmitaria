...
const estaFechadoHoje = datasFechado.includes(dataHojeISO);
  ...
  const produtos = [
    //SEGUNDA-FEIRA
    { id: 101, dia:"Segunda-feira", nome: "Opção 1", precos: {P:22.00, M:25.00, G:28.00}, categoria: "Marmitas", destaque: true, desc: "Arroz, feijão, Isca de carne acebolada. ", imagem: "/iscacarne-aceb.png" },
    { id: 102, dia:"Segunda-feira", nome: "Opção 2", precos: {P:22.00, M:25.00, G:28.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, feijão, Frango xadrez.", imagem: "/frango-xadrez.png" },
    { id: 103, dia:"Segunda-feira", nome: "Opção 3", precos: {P:22.00, M:25.00, G:28.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, feijão, Omelete caipira.", imagem: "/omelete-caipira.png" }, 
    
    //TERÇA-FEIRA
    { id: 104, dia:"Terça-feira", nome: "Opção 1", precos: {P:22.00, M:25.00, G:28.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, feijão, Filé de frango fricandole.", imagem: "/file-frango-fricandole.png" },
    { id: 105, dia:"Terça-feira", nome: "Opção 2", precos: {P:22.00, M:25.00, G:28.00}, categoria: "Marmitas", destaque: true, desc: "Arroz, feijão, Carne moída primavera.", imagem: "/carne-moida-primavera.png" },
    ...
    { id: 109, dia:"Quarta-feira", nome: "Opção 3", precos: {P:22.00, M:25.00, G:28.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, feijão, Kibe frito.", imagem: "/kibe-frito.png" },  
    ...
    { id: 111, dia:"Quinta-feira", nome: "Opção 2", precos: {P:24.00, M:28.00, G:30.00}, categoria:"Marmitas", destaque: true, desc:"Arroz, feijão, Linguiça assada.", imagem:"/linguica-assada.png"},
    { id: 112, dia:"Quinta-feira", nome: "Opção 3", precos: {P:22.00, M:25.00, G:28.00}, categoria:"Marmitas", destaque: false, desc:"Arroz feijão, Bisteca acebolada.", imagem:"/bisteca-acebolada.png"}, 
    
    //SEXTA-FEIRA
    { id: 113, dia:"Sexta-feira", nome: "Opção 1", precos: {P:24.00, M:28.00, G:30.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, feijão, Pernil acebolado. ", imagem: "/pernil-acebolado.png" },
    { id: 114, dia:"Sexta-feira", nome: "Opção 2", precos: {P:22.00, M:24.00, G:28.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, feijão, Costela com batata.", imagem: "/costela-batata.png" },
    { id: 115, dia:"Sexta-feira", nome: "Opção 3", precos: {P:24.00, M:28.00, G:30.00}, categoria: "Marmitas", destaque: true, desc: "Arroz, feijão, Bife na manteiga.", imagem: "/bife-manteiga.png" }, 
  ...
  const acompanhamentosDaSemana = {
    "Segunda-feira": "Legumes refogado/ farofa",
    "Terça-feira": "Chuchu refogado / purê de batata.",
    "Quarta-feira": "Farofa / couve refogada / batata palha.",
    "Quinta-feira": " Macarrão / polenta / cuscuz paulista.",
    "Sexta-feira": "Farofa / batata doce.",
        ...
        <div key={categoria} className="grupo-categoria">
          ...
          {categoria === "Marmitas" && verSemana && (
            <div className="cardapio-semanal-expansivel" style={{ marginTop: '20px', padding: '15px', backgroundColor: '#fdf2f0', borderRadius: '12px', border: '1px solid #d66458' }}>
              <h4 style={{ color: '#d66458', marginBottom: '15px' }}>📅 Conferência do Cardápio Semanal- 22/06 à 28/06 </h4>
